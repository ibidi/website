  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (groupedBookmarks.value.size > 0) {
        ...
        _push(`<div class="text-center py-12" data-v-1b547f2c><p class="text-lg text-zinc-500 dark:text-zinc-400" data-v-1b547f2c>Henüz hiç yer imi eklenmemiş.</p></div>`);
      }
      _push(`</div></div></div>`);
    };
  }
...
//# sourceMappingURL=bookmarks-DdT80J7e.js.map
