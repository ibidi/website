import { defineComponent, ref, mergeProps, withCtx, createVNode, toDisplayString, computed, useSSRContext } from 'file:///Users/ibidi/Desktop/website/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderList, ssrRenderComponent, ssrInterpolate, ssrRenderAttr, ssrRenderStyle, ssrRenderSlot } from 'file:///Users/ibidi/Desktop/website/node_modules/vue/server-renderer/index.mjs';
  ...
  setup(__props) {
    const galleryItems = ref([
      ...
      },
      {
        ...
        altText: "Teknolojik ve soyut g\xF6rsel",
        gridSize: 15,
        pixelColor: "#60a5fa",
        // Blue
        duration: 0.25
      },
      {
        ...
        title: "Lezzet \u015E\xF6leni",
        description: "Rengarenk ve i\u015Ftah a\xE7\u0131c\u0131 yiyecekler.",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "relative pt-32 pb-16 bg-white dark:bg-zinc-900 overflow-hidden" }, _attrs))} data-v-17f85663><div class="container mx-auto max-w-6xl px-4" data-v-17f85663><div class="text-center mb-12" data-v-17f85663><h1 class="text-4xl font-bold tracking-tight text-zinc-900 dark:text-zinc-100 sm:text-5xl" data-v-17f85663> Galeri </h1><p class="mt-6 text-lg leading-8 text-zinc-600 dark:text-zinc-400" data-v-17f85663> Piksel ge\xE7i\u015F efektleriyle olu\u015Fturulmu\u015F g\xF6rseller. </p></div><div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 place-items-center" data-v-17f85663><!--[-->`);
      ssrRenderList(galleryItems.value, (item) => {
        _push(ssrRenderComponent(PixelTransition, {
          ...
          firstContent: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<img${ssrRenderAttr("src", item.firstImage)}${ssrRenderAttr("alt", item.altText || "Galeri \xF6\u011Fesi")} class="w-full h-full object-cover" data-v-17f85663${_scopeId}>`);
            } else {
              return [
                createVNode("img", {
                  src: item.firstImage,
                  alt: item.altText || "Galeri \xF6\u011Fesi",
...
//# sourceMappingURL=gallery-C7kWaYrW.mjs.map
