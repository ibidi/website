import { b as useRuntimeConfig, a as __nuxt_component_0, _ as __nuxt_component_0$2 } from './server.mjs';
import { defineComponent, ref, computed, mergeProps, withCtx, createVNode, createTextVNode, watch, resolveDynamicComponent, TransitionGroup, createBlock, openBlock, Fragment, renderList, toDisplayString, useSSRContext } from 'file:///Users/ibidi/Desktop/website/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderClass, ssrInterpolate, ssrRenderAttr, ssrRenderList, ssrRenderVNode, ssrRenderStyle, ssrRenderSlot } from 'file:///Users/ibidi/Desktop/website/node_modules/vue/server-renderer/index.mjs';
import { _ as _export_sfc } from './_plugin-vue_export-helper-1tPrXgE0.mjs';
import { useIntersectionObserver } from 'file:///Users/ibidi/Desktop/website/node_modules/@vueuse/core/index.mjs';
import { gsap as gsap$2 } from 'file:///Users/ibidi/Desktop/website/node_modules/gsap/dist/gsap.js';
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            ssrRenderList(segments.value, (segment, index) => {
              ...
              })}"${ssrRenderAttr("data-index", index)} data-v-175f92f1${_scopeId}>${ssrInterpolate(segment === " " ? "\xA0" : segment)}</span>`);
            });
            _push2(`</span>`);
          } else {
            return [
                ...
                default: withCtx(() => [
                  (openBlock(true), createBlock(Fragment, null, renderList(segments.value, (segment, index) => {
                    return openBlock(), createBlock("span", {
                      ...
                      "data-index": index
                    }, toDisplayString(segment === " " ? "\xA0" : segment), 13, ["data-index"]);
                  }), 128))
                ]),
                _: 1
              })
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const jobs = [
      ...
      {
        id: 3,
        company: "Aksis G\xFCzellik Salonlar\u0131",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (lastPlayedTrack.value) {
        ...
        if (lastPlayedTrack.value.url) {
          ...
          if (lastPlayedTrack.value.nowPlaying) {
            _push(`<span class="text-xs text-emerald-500">(\u015Fimdi \xE7al\u0131yor)</span>`);
          } else {
            _push(`<span class="text-xs text-zinc-500">(son \xE7alan)</span>`);
          }
          _push(`</a>`);
        } else {
        ...
        _push(`<span>M\xFCzik aktivitesi yok</span></span>`);
      ...
      _push(ssrRenderComponent(ShinyText, {
        text: "Full Stack Web Developer - in \u2764\uFE0F with Node.js, TypeScript, React.js and Vue.js - \u{1F1F9}\u{1F1F7}",
        tag: "p",
      ...
      if (recentTracks.value.length > 0) {
        ...
        ssrRenderList(recentTracks.value, (track) => {
          ...
          _push(`</div></div><p class="text-xs text-zinc-400 dark:text-zinc-500 mt-1">${ssrInterpolate(track.playedAt === "\u015Eimdi \xE7al\u0131yor" ? track.playedAt : formatDate(track.playedAt))}</p></div></div></div>`);
        });
        _push(`<!--]--></div>`);
      } else if (!fetchError.value) {
        ...
        _push(`<p class="text-zinc-600 dark:text-zinc-400">Hen\xFCz \u015Fark\u0131 dinlememi\u015F g\xF6r\xFCn\xFCyorsunuz</p></div>`);
      } else {
        _push(`<div class="text-center py-8">`);
        _push(ssrRenderComponent(_component_Icon, {
          name: "carbon:error",
...
//# sourceMappingURL=index-YBL09H7n.mjs.map
