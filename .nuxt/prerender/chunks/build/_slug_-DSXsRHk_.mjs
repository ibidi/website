import { e as useAsyncData, d as useRoute, _ as __nuxt_component_0$2, a as __nuxt_component_0 } from './server.mjs';
import _sfc_main$1 from './ContentDoc-Ub2Vmos4.mjs';
import { defineComponent, withAsyncContext, ref, mergeProps, withCtx, createVNode, unref, createTextVNode, useSSRContext } from 'file:///Users/ibidi/Desktop/website/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderStyle, ssrInterpolate, ssrRenderList, ssrRenderAttr } from 'file:///Users/ibidi/Desktop/website/node_modules/vue/server-renderer/index.mjs';
...
import './ContentRenderer-DIiy9PWV.mjs';
...
import './ContentQuery-WEMf9ase.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_ContentDoc, null, {
        "not-found": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<p${_scopeId}>\u0130\xE7erik bulunamad\u0131.</p>`);
          } else {
            return [
              createVNode("p", null, "\u0130\xE7erik bulunamad\u0131.")
            ];
          }
        }),
        _: 1
...
//# sourceMappingURL=_slug_-DSXsRHk_.mjs.map
