import { defineComponent, shallowRef, h, resolveComponent, computed, hasInjectionContext, inject, toValue, getCurrentInstance, onServerPrefetch, toRef, isRef, ref, nextTick, unref, createElementBlock, provide, cloneVNode, defineAsyncComponent, shallowReactive, Suspense, Fragment, useSSRContext, createApp, mergeProps, withCtx, createVNode, onErrorCaptured, resolveDynamicComponent, reactive, effectScope, isReadonly, isShallow, isReactive, toRaw, getCurrentScope } from 'file:///Users/ibidi/Desktop/website/node_modules/vue/index.mjs';
import { $fetch as $fetch$1 } from 'file:///Users/ibidi/Desktop/website/node_modules/ofetch/dist/node.mjs';
...
import { getContext, executeAsync } from 'file:///Users/ibidi/Desktop/website/node_modules/unctx/dist/index.mjs';
import { createError as createError$1, sanitizeStatusCode, appendHeader } from 'file:///Users/ibidi/Desktop/website/node_modules/h3/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///Users/ibidi/Desktop/website/node_modules/vue-router/dist/vue-router.node.mjs';
import { toRouteMatcher, createRouter as createRouter$1 } from 'file:///Users/ibidi/Desktop/website/node_modules/radix3/dist/index.mjs';
import defu$1, { defuFn, defu } from 'file:///Users/ibidi/Desktop/website/node_modules/defu/dist/defu.mjs';
import { parseQuery, hasProtocol, joinURL, withQuery, withTrailingSlash, withoutTrailingSlash, isScriptProtocol } from 'file:///Users/ibidi/Desktop/website/node_modules/ufo/dist/index.mjs';
import { klona } from 'file:///Users/ibidi/Desktop/website/node_modules/klona/dist/index.mjs';
import { Icon, getIcon, loadIcon as loadIcon$1, _api, disableCache, addAPIProvider, setCustomIconsLoader } from 'file:///Users/ibidi/Desktop/website/node_modules/@iconify/vue/dist/iconify.mjs';
import { ssrRenderAttrs, ssrInterpolate, ssrRenderComponent, ssrRenderSuspense, ssrRenderVNode } from 'file:///Users/ibidi/Desktop/website/node_modules/vue/server-renderer/index.mjs';
import { getIconCSS } from 'file:///Users/ibidi/Desktop/website/node_modules/@iconify/utils/lib/css/icon.mjs';
import { debounce } from 'file:///Users/ibidi/Desktop/website/node_modules/perfect-debounce/dist/index.mjs';
import { u as useSeoMeta$1, a as useHead$1, h as headSymbol, b as useServerHead$1 } from '../_/renderer.mjs';
...
const _routes = [
  {
    name: "404",
    path: "/404",
    component: () => import('./404-DTALqSkN.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-YBL09H7n.mjs')
  },
  {
    name: "muzik",
    path: "/muzik",
    component: () => import('./muzik-Dsh1axkx.mjs')
  },
  {
    name: "contact",
    path: "/contact",
    meta: __nuxt_page_meta$8 || {},
    component: () => import('./contact-B9DDFvQJ.mjs')
  },
  {
    name: "gallery",
    path: "/gallery",
    meta: __nuxt_page_meta$7 || {},
    component: () => import('./gallery-C7kWaYrW.mjs')
  },
  {
    name: __nuxt_page_meta$6 == null ? void 0 : __nuxt_page_meta$6.name,
    path: "/projects",
    component: () => import('./projects-Bz8FR1p7.mjs'),
    children: [
      {
        name: "projects",
        path: "",
        component: () => import('./index-_96WWBfU.mjs')
      }
    ]
  },
  {
    ...
    component: () => import('./bookmarks-DdT80J7e.mjs')
  },
  {
    name: "resources",
    path: "/resources",
    meta: __nuxt_page_meta$4 || {},
    component: () => import('./resources-D-suuDW-.mjs')
  },
  {
    name: "blog",
    path: "/blog",
    component: () => import('./index-BpJbvlfl.mjs')
  },
  {
    name: "blog-single",
    path: "/blog/:slug()",
    meta: __nuxt_page_meta$3 || {},
    component: () => import('./_slug_-DSXsRHk_.mjs')
  },
  {
    name: "repositories",
    path: "/repositories",
    meta: __nuxt_page_meta$2 || {},
    component: () => import('./repositories-Cuy042lY.mjs')
  },
  {
    name: "blog-catch-all",
    path: "/blog/:slug(.*)*",
    meta: __nuxt_page_meta$1 || {},
    component: () => import('./_...slug_-6Vliy2Bh.mjs')
  },
  {
    name: "daily-songs",
    path: "/daily-songs",
    meta: __nuxt_page_meta || {},
    component: () => import('./index-CyePriAA.mjs')
  }
];
...
const LazyContentDoc = defineAsyncComponent(() => import('./ContentDoc-Ub2Vmos4.mjs').then((r) => r["default"] || r.default || r));
const LazyContentList = defineAsyncComponent(() => import('./ContentList-BeUtfiRE.mjs').then((r) => r["default"] || r.default || r));
const LazyContentNavigation = defineAsyncComponent(() => import('./ContentNavigation-Ho4MPFIb.mjs').then((r) => r["default"] || r.default || r));
const LazyContentQuery = defineAsyncComponent(() => import('./ContentQuery-WEMf9ase.mjs').then((r) => r["default"] || r.default || r));
const LazyContentRenderer = defineAsyncComponent(() => import('./ContentRenderer-DIiy9PWV.mjs').then((r) => r["default"] || r.default || r));
const LazyContentRendererMarkdown = defineAsyncComponent(() => import('./ContentRendererMarkdown-BJu3ngqT.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProseA = defineAsyncComponent(() => import('./ProseA-CnuKyQNX.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProseH1 = defineAsyncComponent(() => import('./ProseH1-BS5lh3vB.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH2 = defineAsyncComponent(() => import('./ProseH2-B-qTyO4Z.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH3 = defineAsyncComponent(() => import('./ProseH3-DNsYSf_u.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH4 = defineAsyncComponent(() => import('./ProseH4-D-b7IEcx.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH5 = defineAsyncComponent(() => import('./ProseH5-C8_2vP30.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH6 = defineAsyncComponent(() => import('./ProseH6-fRFuN2_V.mjs').then((r) => r["default"] || r.default || r));
const LazyProseHr = defineAsyncComponent(() => import('./ProseHr-Bidow6pB.mjs').then((r) => r["default"] || r.default || r));
const LazyProseImg = defineAsyncComponent(() => import('./ProseImg-BATRPBnL.mjs').then((r) => r["default"] || r.default || r));
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-DRiKl4yF.mjs').then((m) => m.default || m))
};
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<footer${ssrRenderAttrs(mergeProps({ class: "mt-12 py-8 border-t border-zinc-200 dark:border-zinc-700/50 text-zinc-600 dark:text-zinc-400 text-sm" }, _attrs))}><div class="container mx-auto max-w-7xl px-4 flex flex-col md:flex-row items-center justify-between gap-6"><div class="text-xs"><span>v1.0.1</span></div><div class="text-center order-first md:order-none flex-grow"><p>© ${ssrInterpolate((/* @__PURE__ */ new Date()).getFullYear())} İhsan Baki Doğan. Tüm hakları saklıdır.</p><a href="https://github.com/ibidi/website" target="_blank" class="hover:text-violet-500 dark:hover:text-violet-400 transition-colors duration-200"> This website is open-source on GitHub </a></div><div class="flex items-center gap-3"><a href="https://github.com/ibidi" target="_blank" aria-label="GitHub" class="hover:text-violet-500 dark:hover:text-violet-400 transition-colors">`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "carbon:logo-github",
        class: "w-5 h-5"
      }, null, _parent));
      _push(`</a><a href="https://twitter.com/ibidicodes" target="_blank" aria-label="Twitter" class="hover:text-violet-500 dark:hover:text-violet-400 transition-colors">`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "carbon:logo-twitter",
        class: "w-5 h-5"
      }, null, _parent));
      _push(`</a><a href="https://linkedin.com/in/ibidi" target="_blank" aria-label="LinkedIn" class="hover:text-violet-500 dark:hover:text-violet-400 transition-colors">`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "carbon:logo-linkedin",
        class: "w-5 h-5"
      }, null, _parent));
      _push(`</a><a href="https://instagram.com/ihsanbakidogann" target="_blank" aria-label="Instagram" class="hover:text-violet-500 dark:hover:text-violet-400 transition-colors">`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "carbon:logo-instagram",
        class: "w-5 h-5"
      }, null, _parent));
      _push(`</a></div><button title="Scroll to top" class="hidden md:inline-flex items-center justify-center w-9 h-9 bg-zinc-100 dark:bg-zinc-800/50 rounded-md border border-zinc-200 dark:border-zinc-700/50 text-zinc-600 dark:text-zinc-400 hover:bg-zinc-200 dark:hover:bg-zinc-800 transition-all duration-200 ml-4">`);
      _push(ssrRenderComponent(_component_Icon, {
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex flex-col min-h-screen bg-white dark:bg-zinc-900" }, _attrs))}>`);
      _push(ssrRenderComponent(_component_NuxtLoadingIndicator, {
        height: 3,
        color: "#818cf8"
      }, null, _parent));
      _push(ssrRenderComponent(_component_ClientOnly, null, {}, _parent));
      _push(`<header class="fixed inset-x-0 top-0 z-30 backdrop-blur bg-white/80 dark:bg-zinc-900/80 border-b border-zinc-200 dark:border-zinc-700/50 will-change-transform"><div class="container mx-auto max-w-4xl px-4 h-16"><div class="flex items-center justify-between h-full">`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="w-[48px] h-[48px] bg-black rounded-lg flex items-center justify-center"${_scopeId}><img src="https://i.hizliresim.com/q41aejn.png" alt="ibidi" class="w-11 h-11" loading="eager" decoding="async"${_scopeId}></div>`);
          } else {
            return [
              createVNode("div", { class: "w-[48px] h-[48px] bg-black rounded-lg flex items-center justify-center" }, [
                createVNode("img", {
      ...
      _push(`<div class="flex items-center gap-2"><button class="inline-flex items-center justify-center w-10 h-10 bg-zinc-100 dark:bg-zinc-800/50 rounded-md text-zinc-600 dark:text-zinc-400 border border-zinc-200 dark:border-zinc-700/50 transition-all duration-200 hover:bg-zinc-200 dark:hover:bg-zinc-800">`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "carbon:menu",
        class: "text-base"
      }, null, _parent));
      _push(`</button><button class="inline-flex items-center justify-center w-10 h-10 bg-zinc-100 dark:bg-zinc-800/50 rounded-md text-zinc-600 dark:text-zinc-400 border border-zinc-200 dark:border-zinc-700/50 transition-all duration-200 hover:bg-zinc-200 dark:hover:bg-zinc-800">`);
      ...
      _push(`</button></div></div></div></header><div class="flex-1 flex flex-col">`);
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-nAHfRz5A.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-AfwZ38Nn.mjs'));
...
export { __nuxt_component_0$2 as _, __nuxt_component_0 as a, useRuntimeConfig as b, useSeoMeta as c, useRoute as d, entry$1 as default, useAsyncData as e, useRequestEvent as f, useNuxtApp as g, useState as h, useHead as u };
